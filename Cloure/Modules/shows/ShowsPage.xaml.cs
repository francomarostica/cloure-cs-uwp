...
namespace Cloure.Modules.shows
{
    ...
    public sealed partial class ShowsPage : Page
    {
        ...
        public async void LoadData()
        {
            ...
            GenericResponse genericResponse = await Shows.GetList(Filter, OrderBy, OrderType, Page);
        ...
        {
            CloureManager.Navigate(typeof(ShowAddPage));
        }
        ...
        private void lstItems_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            ...
            if (((FrameworkElement)e.OriginalSource).DataContext.GetType() == typeof(Show))
            {
                Show product = (Show)((FrameworkElement)e.OriginalSource).DataContext;
        ...
        private void MenuFlyoutItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            Show product = (Show)menuFlyoutItem.Tag;
        ...
        private async void DisplayDeleteDialog(int id)
        {
            ...
            {
                bool api_result = await Shows.Delete(id);
        ...
        {
            Show product = (Show)e.ClickedItem;
            edit(product.Id);
        }
