...
namespace Cloure.Modules.bands_artists
{
    ...
    /// </summary>
    public sealed partial class BandsArtistsPage : Page
    {
        ...
        private void lstItems_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            ...
            BandArtist product = (BandArtist)((FrameworkElement)e.OriginalSource).DataContext;
        ...
        private void MenuFlyoutItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            BandArtist product = (BandArtist)menuFlyoutItem.Tag;
        ...
        void edit(int id)
        {
            CloureManager.Navigate(typeof(BandArtistAddPage), id);
        }
        ...
        {
            BandArtist product = (BandArtist)e.ClickedItem;
            edit(product.Id);
        }
    }
}
