...
{
    public static class BandsArtists
    {
            ...
            try
            {
                ...
                if (error == "")
                {
                    ...
                    foreach (JsonValue jsonValue in registers)
                    {
                        ...
                        item.ImageUrl = new Uri(register.GetNamedString("Imagen"));
        ...
        public static async Task<int> save(BandArtist bandArtist)
        {
            ...
            try
            {
                ...
                if (bandArtist.CloureImage != null) cparams.Add(new CloureParam("image", bandArtist.CloureImage));
                string res = await CloureManager.ExecuteAsync(cparams);
