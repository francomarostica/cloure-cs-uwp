...
namespace Cloure.Modules.credit_cards
{
    ...
    /// </summary>
    public sealed partial class CreditCardAddPage : Page
    {
        CreditCard creditCard;
        ModuleInfo moduleInfo;

        public CreditCardAddPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter != null)
            {
                if (e.Parameter.GetType() == typeof(CreditCard))
                {
                    creditCard = (CreditCard)e.Parameter;
        ...
        private async void Save()
        {
            ...
            if (await CreditCards.save(creditCard))
            {
