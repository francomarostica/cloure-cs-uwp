...
namespace Cloure.Modules.places
{
    ...
    public sealed partial class PlacesPage : Page
    {
        ...
        public async void LoadData()
        {
            ...
            GenericResponse genericResponse = await Places.GetList(Filter, OrderBy, OrderType, Page);
        ...
        private void lstItems_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            ...
            Place product = (Place)((FrameworkElement)e.OriginalSource).DataContext;
        ...
        private void MenuFlyoutItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            Place product = (Place)menuFlyoutItem.Tag;
        ...
        void edit(int id)
        {
            CloureManager.Navigate(typeof(PlaceAddPage), id);
        }
        ...
        private async void DisplayDeleteDialog(int id)
        {
            ...
            {
                bool api_result = await Places.Delete(id);
        ...
        {
            Place product = (Place)e.ClickedItem;
            edit(product.Id);
        }
    }
}
