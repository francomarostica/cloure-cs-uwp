...
namespace Cloure.Modules.shows_news
{
    ...
    /// </summary>
    public sealed partial class ShowsNewsPage : Page
    {
        ...
        {
            CloureManager.Navigate(typeof(ShowsNewsAddPage));
        }
        ...
        private void lstItems_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            ...
            if (((FrameworkElement)e.OriginalSource).DataContext.GetType() == typeof(ShowArticle))
            {
                ShowArticle product = (ShowArticle)((FrameworkElement)e.OriginalSource).DataContext;
        ...
        private void MenuFlyoutItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            ShowArticle product = (ShowArticle)menuFlyoutItem.Tag;
        ...
        void edit(int id)
        {
            CloureManager.Navigate(typeof(ShowsNewsAddPage), id);
        }
        ...
        {
            ShowArticle product = (ShowArticle)e.ClickedItem;
            edit(product.Id);
        }
    }
}
