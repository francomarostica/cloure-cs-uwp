...
namespace Cloure.Modules.photographer_performance
{
    ...
    /// </summary>
    public sealed partial class PhotographersPerformancePage : Page
    {
        ModuleInfo moduleInfo;

        private string Filter = "";
        private string OrderBy = "prom";
        ...
        {
            PhotographerPerformanceResponse historyResponse = await PhotographersPerformance.GetList(Filter, OrderBy, OrderType, Since, Until, MovementType, CompanyBranch, Page);
