...
namespace Cloure.Modules.bank_checks
{
    ...
    /// </summary>
    public sealed partial class BankChecksPage : Page
    {
        ...
        public async void LoadData()
        {
            ...
            GenericResponse genericResponse = await BankChecks.GetList(Filter, OrderBy, OrderType, Page);
        ...
        {
            BankCheck bank = (BankCheck)e.ClickedItem;
            edit(bank);
        }

        void edit(BankCheck bank)
        {
        ...
        private void lstItems_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            ...
            BankCheck bank = (BankCheck)((FrameworkElement)e.OriginalSource).DataContext;
        ...
        private void MenuFlyoutItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            BankCheck bank = (BankCheck)menuFlyoutItem.Tag;
            if (menuFlyoutItem.Name == "edit") edit(bank);
            if (menuFlyoutItem.Name == "delete") DisplayDeleteDialog(bank);
        }

        private async void DisplayDeleteDialog(BankCheck bank)
        {
            ...
            {
                bool api_result = await BankChecks.Delete(bank.Id);
